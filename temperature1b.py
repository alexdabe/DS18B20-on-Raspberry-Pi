...
def sauvegarde(temperature_ext, temperature_int, tp, h, date, emplacement):
...
while True:
    ...
    sauvegarde(temperature_ext, temperature_int, date, "Temp.csv")  # Appel de la fonction sauvegarde avec 3 variables
    time.sleep(120)
